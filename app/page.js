...
export default function LandingPage() {
  ...
  const runScrollAnimations = useCallback(() => {
  ...
  useEffect(() => {
    const observer = runScrollAnimations();
    return () => observer.disconnect();
  }, [lang, runScrollAnimations]);
  ...
  const translations = {
    en: {
      ...
      tags: ["Secondary school", "Undergraduates", "Graduates", "Nigeria", "Francophone Africa", "Global"],
      howTitle: "How it works",
      howSubtitle: "Three steps to your path",
      howCaption: "Takes less than 5 minutes to get your personalized roadmap",
      howSteps: [
      ...
      whoCaption: "Whether you're in SS3 or just graduated, PathForge meets you where you are",
      whoBlocks: [
      ...
      ctaSub: "Join students across Africa and the world already building their futures with PathForge",
    ...
    fr: {
      ...
      heroSub: "Du secondaire à ton premier emploi — PathForge te donne une feuille de route personnalisée, des opportunités adaptées et un mentor IA qui comprend vraiment ta situation.",
      navSignIn: "Connexion",
      navGetStarted: "Commencer gratuitement",
      heroPrimaryCta: "Commencer — c'est gratuit",
      heroSecondaryCta: "Voir comment ça marche",
      tags: ["Lycée", "Étudiants", "Diplômés", "Nigéria", "Afrique francophone", "Global"],
      howTitle: "Comment ça marche",
      howSubtitle: "Trois étapes vers ta voie",
      howCaption: "Moins de 5 minutes pour obtenir ta feuille de route personnalisée",
      howSteps: [
        { num: "1", title: "Parle-nous de toi", sub: "Ton niveau, tes centres d'intérêt, tes compétences et tes objectifs. Un quiz rapide en 7 étapes — sans blabla." },
        { num: "2", title: "Reçois ton plan IA", sub: "Un plan de carrière personnalisé, étape par étape, avec ressources réelles, salaires pour ton pays et écarts de compétences." },
        { num: "3", title: "Découvre des opportunités", sub: "Emplois, bourses, formations et programmes — tous classés selon ton profil." },
      ],
      whoTitle: "Pour qui ?",
      whoSubtitle: "Conçu pour chaque étape",
      whoCaption: "Que tu sois en terminale ou tout juste diplômé, PathForge te rejoint là où tu es",
      whoBlocks: [
        { tag: "Lycéens", title: "Découvre ce que tu veux vraiment faire", sub: "Orientation, choix de matières et projets d'université — avant de prendre des décisions que tu regretteras." },
        { tag: "Candidats à l'université", title: "Choisis le bon cursus pour les bonnes raisons", sub: "Compare les filières, comprends les métiers possibles et fais un choix éclairé pour l'université." },
        { tag: "Étudiants", title: "Construis les bonnes compétences à temps", sub: "Feuille de route année par année, stages et certifications — pour obtenir ton diplôme en étant vraiment compétitif." },
        { tag: "Diplômés & chercheurs d'emploi", title: "Trouve des opportunités adaptées à ton profil", sub: "Emplois, bourses et programmes évalués selon ton profil — avec l'IA qui montre exactement les écarts à combler." },
      ],
      featuresTitle: "Fonctionnalités",
      featuresSubtitle: "Tout au même endroit",
      featuresCaption: "Fini de passer d'un site à un autre pour tout suivre",
      features: [
        { title: "Feuille de route IA", sub: "Plan personnalisé selon ton niveau, ton pays et tes objectifs", icon: <path d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" strokeWidth="1.5" /> },
        { title: "Matching d'opportunités", sub: "Emplois, bourses et cours notés avec un pourcentage d'adéquation", icon: <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" strokeWidth="1.5" /> },
        { title: "Analyse des écarts", sub: "Vois les compétences manquantes et les ressources gratuites pour les combler", icon: <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" strokeWidth="1.5" /> },
        { title: "Mentor IA", sub: "Discute avec une IA qui connaît ton profil et donne de vrais conseils", icon: <path d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" strokeWidth="1.5" /> },
        { title: "Téléchargement PDF", sub: "Télécharge ton plan complet en PDF professionnel", icon: <path d="M12 3v13m0 0l-4-4m4 4l4-4M3 21h18" strokeWidth="1.5" /> },
        { title: "Anglais + Français", sub: "Support complet pour l'Afrique et au-delà dès le premier jour", icon: <path d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" strokeWidth="1.5" /> },
      ],
      ctaBadge: "Commence gratuitement",
      ctaTitle: "Ta voie commence aujourd'hui",
      ctaSub: "Rejoins les étudiants d'Afrique et du monde qui construisent déjà leur avenir avec PathForge",
    ...
    <div className="bg-[#080a0f] text-white min-h-screen overflow-x-hidden">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-0.5">
            <button onClick={() => setLang("en")}
              className={`px-2 py-1 rounded-md text-[11px] font-medium transition ${lang === "en" ? "bg-[#534AB7] text-white" : "text-[#888780] hover:text-white"}`}>
              EN
            </button>
            <button onClick={() => setLang("fr")}
              className={`px-2 py-1 rounded-md text-[11px] font-medium transition ${lang === "fr" ? "bg-[#534AB7] text-white" : "text-[#888780] hover:text-white"}`}>
              FR
            </button>
          </div>
          <Link href="/login" className="hidden sm:block text-[#888780] text-xs hover:text-white transition border border-[#2C2C2A] rounded-lg px-4 py-2">
            {t.navSignIn}
          </Link>
          <Link href="/signup" className="bg-[#534AB7] hover:bg-[#4840a0] text-white text-xs font-medium rounded-lg px-3 py-2 transition">
            <span className="hidden sm:inline">{t.navGetStarted}</span>
            <span className="sm:hidden">{lang === "fr" ? "Commencer" : "Get started"}</span>
          </Link>
        </div>
      </nav>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-20 md:pt-24 pb-20 text-center">
        ...
        <div className="scroll-animate">
          <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-4">{t.tagline}</p>
        </div>
        ...
        <div className="scroll-animate scroll-animate-delay-2">
          <p className="text-[#888780] text-sm md:text-base leading-relaxed mb-8 max-w-lg mx-auto">{t.heroSub}</p>
        </div>
        ...
        <div className="scroll-animate scroll-animate-delay-4">
          <div className="flex items-center justify-center gap-2 flex-wrap">
            {t.tags.map((tag) => (
              <span key={tag} className="text-[11px] px-3 py-1 rounded-full border border-[#2C2C2A] text-[#888780]">{tag}</span>
            ))}
          </div>
        </div>
      </div>
      ...
      <div id="how-it-works" className="max-w-4xl mx-auto px-6 py-16">
        <div className="scroll-animate text-center mb-10">
          <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-3">{t.howTitle}</p>
          <h2 className="text-2xl font-medium mb-2">{t.howSubtitle}</h2>
          <p className="text-[#888780] text-sm">{t.howCaption}</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {t.howSteps.map((step, i) => (
            <div key={step.num} className={`scroll-animate scroll-animate-delay-${i + 1} bg-[#0f1117] border border-[#2C2C2A] rounded-xl p-6 hover:border-[#7F77DD]/20 transition`}>
              <div className="w-7 h-7 bg-[#1a1830] rounded-lg flex items-center justify-center text-[#7F77DD] text-xs font-medium mb-4">{step.num}</div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="scroll-animate text-center mb-10">
          <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-3">{t.whoTitle}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {t.whoBlocks.map((item, i) => (
            <div key={item.tag} className={`scroll-animate scroll-animate-delay-${i + 1} bg-[#0f1117] border border-[#2C2C2A] rounded-xl p-6 hover:border-[#444441] transition`}>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="scroll-animate text-center mb-10">
          <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-3">{t.featuresTitle}</p>
          <h2 className="text-2xl font-medium mb-2">{t.featuresSubtitle}</h2>
          <p className="text-[#888780] text-sm">{t.featuresCaption}</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {t.features.map((feat, i) => (
            <div key={feat.title} className={`scroll-animate scroll-animate-delay-${i + 1} bg-[#0f1117] border border-[#2C2C2A] rounded-xl p-5 hover:border-[#7F77DD]/20 transition`}>
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-24 text-center overflow-hidden">
        ...
        <div className="scroll-animate">
          <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-4 relative">{t.ctaBadge}</p>
          <h2 className="text-3xl font-medium mb-4 relative">{t.ctaTitle}</h2>
          <p className="text-[#888780] text-sm mb-8 relative">{t.ctaSub}</p>
      ...
      <footer className="px-6 md:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#444441] text-xs">{t.footerBuilt}</span>
        </div>
        <div className="flex items-center gap-6">
          <Link href="/privacy" className="text-[#444441] text-xs hover:text-[#888780] transition">{t.footerPrivacy}</Link>
          <Link href="/terms" className="text-[#444441] text-xs hover:text-[#888780] transition">{t.footerTerms}</Link>
          <Link href="/contact" className="text-[#444441] text-xs hover:text-[#888780] transition">{t.footerContact}</Link>
        </div>
      </footer>
    </div>
  );
