...
export default function LandingPage() {
  ...
  const t = {
    ...
    heroSecondaryCta:
      lang === "en" ? "See how it works" : "Voir comment ça marche",
    ctaBadge:
      lang === "en" ? "Free to get started" : "Commence gratuitement",
    ctaTitle:
      lang === "en" ? "Your path starts today" : "Ta voie commence aujourd’hui",
    ctaSub:
      lang === "en"
    ...
    <div className="bg-[#080a0f] text-white min-h-screen overflow-x-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-10 py-4 border-b border-[#2C2C2A]">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/login"
            className="text-[#888780] text-xs hover:text-white transition border border-[#2C2C2A] rounded-lg px-4 py-2"
          >
            {t.navSignIn}
          </Link>
          <Link
            href="/signup"
            className="bg-[#534AB7] hover:bg-[#4840a0] text-white text-xs font-medium rounded-lg px-4 py-2 transition"
          >
            {t.navGetStarted}
          </Link>
        </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-20 md:pt-24 pb-20 text-center">
        ...
        {/* Mobile floating cards — only keep the first one so nothing blocks text */}
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="scroll-animate text-center mb-10">
          ...
          <p className="text-[#888780] text-sm">
            Whether you're in SS3 or just graduated, PathForge meets you where
            you are
          </p>
        </div>
      ...
      <footer className="px-6 md:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#444441] text-xs">
            © 2025. Built for students everywhere.
          </span>
        </div>
