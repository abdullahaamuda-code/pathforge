  ...
  return (
    <div className="bg-[#080a0f] text-white min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        {/* Floating cards */}
        <div className="hidden md:block absolute left-0 top-16 animate-bounce" style={{ animationDuration: "4s" }}>
        ...
        <div className="hidden md:block absolute right-0 top-32 animate-bounce" style={{ animationDuration: "5s", animationDelay: "1s" }}>
        ...
        <div className="hidden md:block absolute left-8 bottom-8 animate-bounce" style={{ animationDuration: "6s", animationDelay: "2s" }}>
          <div className="bg-[#0f1117] border border-[#2C2C2A] rounded-xl p-3 text-left w-44">
        ...
        <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-4 animate-fade-in">
      ...
      <div id="how-it-works" className="max-w-4xl mx-auto px-6 py-16">
        <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-3 text-center">How it works</p>
        <h2 className="text-2xl font-medium text-center mb-2">Three steps to your path</h2>
        <p className="text-[#888780] text-sm text-center mb-10">Takes less than 5 minutes to get your personalized roadmap</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={step.num} className="bg-[#0f1117] border border-[#2C2C2A] rounded-xl p-6 hover:border-[#7F77DD]/20 transition">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-3 text-center">Who it's for</p>
        <h2 className="text-2xl font-medium text-center mb-2">Built for every stage</h2>
        <p className="text-[#888780] text-sm text-center mb-10">Whether you're in SS3 or just graduated, PathForge meets you where you are</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <div key={item.tag} className="bg-[#0f1117] border border-[#2C2C2A] rounded-xl p-6 hover:border-[#444441] transition">
      ...
      {/* Features */}
      <div className="max-w-4xl mx-auto px-6 py-16">
        <p className="text-[#7F77DD] text-xs font-medium tracking-widest uppercase mb-3 text-center">Features</p>
        <h2 className="text-2xl font-medium text-center mb-2">Everything in one place</h2>
        <p className="text-[#888780] text-sm text-center mb-10">No more switching between 10 different websites</p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              icon: <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" strokeWidth="1.5" />,
            },
            {
              title: "AI mentor",
            ...
            },
            {
              ...
              icon: <path d="M12 3v13m0 0l-4-4m4 4l4-4M3 21h18" strokeWidth="1.5" />,
            },
            {
              title: "English + French",
              sub: "Full support for Africa and beyond from day one",
              icon: <path d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" strokeWidth="1.5" />,
            },
          ].map((feat) => (
            <div key={feat.title} className="bg-[#0f1117] border border-[#2C2C2A] rounded-xl p-5 hover:border-[#7F77DD]/20 transition">
